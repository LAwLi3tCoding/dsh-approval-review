window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** The full ledger tab. */
		function LedgerView({ view, zh, runCommand, modelChoices }) {
			const [modelDraft, setModelDraft] = (0, react.useState)("");
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							runCommand === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									modelChoices !== void 0 && modelChoices.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										value: modelDraft,
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: zh ? "选择复核模型…" : "choose a reviewer model…"
										}), modelChoices.map((choice) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: choice,
											children: choice
										}, choice))]
		...
		*/
		function apply(ctx) {
			...
			*/
			...
			const inject = (rawSessionId) => ({ runCommand: async (line) => {
