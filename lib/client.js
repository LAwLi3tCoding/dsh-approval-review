	...
	factory: (require) => {
		...
		*/
		...
		function LedgerView({ view, zh, runCommand, modelChoices, loadModels }) {
			...
			const loadOnce = () => {
				if (loadedChoices !== void 0 || loadModels === void 0) return;
				loadModels().then((routes) => {
					setLoadedChoices(routes.length === 0 ? modelChoices ?? [] : reviewerRoutesMerge(modelChoices ?? [], routes));
				}).catch(() => {
					setLoadedChoices(modelChoices ?? []);
				});
			};
							...
							runCommand === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("datalist", {
										id: MODEL_CHOICES_ID,
										children: choices.map((choice) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", { value: choice }, choice))
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
