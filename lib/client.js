window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function directoryRoutes(value) {
			const routes = [];
			const labels = {};
		...
		*/
		function reviewerModelChoices(jevSelectable, llmChoices) {
			const out = jevSelectable ? [...JEV_MODEL_CHOICES] : [];
			const push = (value) => {
		...
		*/
		...
		function ModelPicker({ choices, labels, runCommand, loadModelRoutes, t, onRoutesLoaded }) {
			...
			const loadOnce = () => {
				if (requestedRef.current || loadModelRoutes === void 0) return;
				requestedRef.current = true;
				loadModelRoutes().then((loaded) => onRoutesLoaded(loaded)).catch(() => onRoutesLoaded({
					routes: [],
					labels: {}
				}));
			};
			...
			const textOf = (route) => {
				...
				return name === void 0 ? route : `${route} · ${name}`;
			};
			const itemStyle = {
				display: "block",
				width: "100%",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					...
					children: matches.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: choices.length === 0 ? t("noModels") : t("noMatch")
		...
		* printed verbatim.
		*/
		function rationaleText(record, t) {
		...
		function Entry({ record, t, onApprove, deniedIndex }) {
			...
			const verdict = pending ? t("pending") : record.refused ? t("refused") : record.outcome === "allowed-once" ? t("allowed") : t("delegated");
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							routingTag(record, t) === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									fontSize: 11,
									color: MUTED,
									border: `1px solid ${BORDER}`,
							...
							record.risk === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									t("risk"),
									" ",
									riskLabel(record.risk, t)
								]
							}),
							record.userAuthorization === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								style: {
									fontSize: 11,
									color: MUTED
								},
								children: [
									t("authorization"),
									" ",
									record.userAuthorization === "unknown" ? t("authUnknown") : riskLabel(record.userAuthorization, t)
								]
							}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: rationaleText(record, t)
						})
					}),
					...
					record.reviewerRoute === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Field, {
						label: t("reviewer"),
						mono: true,
						children: [record.reviewerRoute, record.uncertain ? ` · ${t("uncertain")}` : ""]
					}),
					record.argumentsPreview === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: showArgs ? t("hideArgs") : t("showArgs")
					...
					record.refused && record.outcome === "rejected" && onApprove !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: t("approveRetry", { n: deniedIndex })
					}) : null
				]
			});
		}
		...
		*/
		...
		function LedgerView({ view, t, runCommand, modelChoices, loadModelRoutes }) {
			const rootRef = (0, react.useRef)(null);
			...
			const [modelLabels, setModelLabels] = (0, react.useState)({});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: view === void 0 ? t("noData") : view.enabled ? t("autoOn") : t("autoOff")
							}),
							...
							view === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [`${t("reviewer")} `, view.reviewerModel.length > 0 ? `${view.reviewerProvider.length > 0 ? `${view.reviewerProvider}/` : ""}${view.reviewerModel}` : t("inheritSession")]
							}),
					...
					commandError === null ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [t("commandRefused"), commandError]
					}),
...
`;
		...
		*/
		...
		const LOCALE_NS = "approval-review";
		/** Chinese copy. */
		const zh = {
			tab: "审批",
			title: "审批审计",
		...
		*/
		function apply(ctx) {
			...
			const localeOf = () => {
				...
				if (face === void 0) throw new Error("approval-review: the locale service is missing, but this plugin registers its copy into it");
				return face;
			};
			...
			*/
			...
			const inject = (rawSessionId) => ({
				loadModelRoutes: async () => {
					...
					try {
						return directoryRoutes(await directories.directoryFor(rawSessionId).load());
					} catch {
						return {
							routes: [],
							labels: {}
